...
/*
 * This class will contain all the end to end flows related to ISO Login
 */
public class ISOLoginFlows extends Flows {
	...
	public boolean isISOLoginSuccess(ExtentTest logger, String userName,
		...
		logger.log(LogStatus.INFO,
				"STEP 4: Verify the email ID of the user on Profile Page preffered Email ID");
